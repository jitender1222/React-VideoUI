...
const About=()=>{
    ...
    const [video,setVideo]=useState(videoSrc[0]);
    return (
        <Stack direction={['column','row']}>
            <VStack w={["full","full"]} m="20">
                <video 
                controls
                ...
                <VStack alignItems={"flex-start"} overflowY={"auto"} w={"full"}>
                    ...
                    <Text>This is a sample video of testing purpose and this is a description for this video</Text>
                </VStack>
            </VStack>
            <VStack w={"xl"}
            alignItems={'stretch'}
            ...
            <Button mt={"8"} colorScheme={"purple"} variant={"ghost"}
